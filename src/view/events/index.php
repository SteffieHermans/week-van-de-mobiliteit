  ...
  <?php foreach($events as $event): ?>
    <a class="grid-item-link" href="index.php?page=event-detail&amp;id=<?php echo $event['id'];?>">
      <article class="program-grid-item">
        <picture>
          <source media="(min-width: 10px)" srcset="assets/img/<?php echo $event['code']; ?>-grid-580w.webp" type="image/webp"/>
          <img class="grid-image" src="assets/img/<?php echo $event['code']; ?>-grid-290w.jpg" alt="<?php echo $event['title']; ?>" width="290" height="224"
          srcset="assets/img/<?php echo $event['code']; ?>-grid-580w.jpg 580w,
                  assets/img/<?php echo $event['code']; ?>-grid-290w.jpg 290w"
